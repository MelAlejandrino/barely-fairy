...
const linkedProducts = computed(() =>
  (post.value?.linkedProducts ?? []).filter(
    (p): p is Product => '_id' in p
  )
)
...
<template>
  <AppLayout>
    ...
    <article v-else-if="post" class="max-w-2xl">
      ...
      <!-- Body -->
      <div class="text-rose-800/70 text-sm leading-8 tracking-wide
        [&_h1]:text-2xl [&_h1]:font-semibold [&_h1]:text-rose-900 [&_h1]:mb-4 [&_h1]:mt-8
        [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-rose-900 [&_h2]:mb-3 [&_h2]:mt-6
        [&_h3]:text-lg [&_h3]:font-medium [&_h3]:text-rose-900 [&_h3]:mb-2 [&_h3]:mt-4
        [&_p]:mb-5
        [&_strong]:text-rose-900 [&_strong]:font-semibold
        [&_em]:text-rose-600 [&_em]:italic
        [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:mb-4 [&_ul]:text-rose-700
        [&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:mb-4 [&_ol]:text-rose-700
        [&_li]:mb-1
        [&_a]:text-rose-500 [&_a]:underline [&_a]:underline-offset-2 [&_a]:hover:text-rose-700
        [&_blockquote]:border-l-2 [&_blockquote]:border-rose-300 [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:text-rose-400
      ">
      ...
      <div v-if="linkedProducts?.length" class="mt-12">
        ...
        <h2 class="text-xs tracking-widest uppercase text-rose-300 mb-6">
      ...
      <div class="flex items-center justify-between">
        ...
        <span class="text-[10px] tracking-widest uppercase text-rose-300">
          Barely Fairy 🌸
        </span>
      </div>

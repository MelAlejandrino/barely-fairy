...
<template>
  <AppLayout>
          ...
          <div v-if="allImages.length > 1" class="flex gap-2 flex-wrap">
            <button
              ...
              :class="[
                ...
                activeImage === i ? 'border-rose-400' : 'border-rose-200/60 hover:border-rose-300',
              ]"
            >
              <img
        ...
        <div class="flex flex-col gap-5">
          ...
          <div class="flex items-center gap-2">
            ...
            >
              {{
                isInStock
                  ? `In Stock${displayStock ? ` (${displayStock} left)` : ""}`
                  : "Out of Stock"
              }}
            </span>
          </div>
          ...
          <!-- Description -->
          <div v-if="product.description?.length" class="text-sm text-rose-700/60 leading-relaxed">
    ...
    <!-- Not found -->
    <div v-else class="text-rose-300 text-xs tracking-widest uppercase">✕ Product not found</div>
  </AppLayout>
</template>
